...
// Loader Usage
// ============
// 1. replace all occurrences of automedic_ in this file with the plugin namespace prefix eg. my_plugin_
...
// $instance = new automedic_loader($args);				// instantiates loader class
// (ie. search and replace 'automedic_' with 'my_plugin_' function namespace)
...
if ( !class_exists( 'automedic_loader' ) ) {
...
add_action( 'plugins_loaded', 'automedic_load_prefixed_functions', 0 );

if ( !function_exists( 'automedic_load_prefixed_functions' ) ) {
	function automedic_load_prefixed_functions() {
		...
		if ( !function_exists( 'automedic_get_namespace_from_function' ) ) {
			function automedic_get_namespace_from_function( $f ) {
		...
		if ( !function_exists( 'automedic_freemius_instance' ) ) {
			function automedic_freemius_instance() {
				$namespace = automedic_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'automedic_plugin_data' ) ) {
			function automedic_plugin_data() {
				$namespace = automedic_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'automedic_plugin_version' ) ) {
			function automedic_plugin_version() {
				$namespace = automedic_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'automedic_pro_namespace' ) ) {
			function automedic_pro_namespace( $pronamespace ) {
				$namespace = automedic_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'automedic_get_settings' ) ) {
			function automedic_get_settings( $filter = true ) {
				$namespace = automedic_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'automedic_settings_table' ) ) {
			function automedic_settings_table() {
				$namespace = automedic_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'automedic_settings_row' ) ) {
			function automedic_settings_row( $option, $setting ) {
				$namespace = automedic_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'automedic_settings_resources' ) ) {
			function automedic_settings_resources( $media, $color_picker ) {
				$namespace = automedic_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
